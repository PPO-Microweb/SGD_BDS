...
class NL_Checkout {
    ...
    public function getMerchant_site_code() {
        return $this->merchant_site_code;
    }

    public function setMerchant_site_code($merchant_site_code) {
        $this->merchant_site_code = $merchant_site_code;
    }

    public function getSecure_pass() {
        return $this->secure_pass;
    }

    public function setSecure_pass($secure_pass) {
        $this->secure_pass = $secure_pass;
    }

}

add_action("init", 'nganluong_init');

if(!function_exists("nganluong_init")){
